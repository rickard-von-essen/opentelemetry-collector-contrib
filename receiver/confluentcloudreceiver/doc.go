...
// Package confluentcloudreceiver implements a receiver that can be used by the
// Opentelemetry collector to receive metrcis from Confluent Cloud's Metric API v2
